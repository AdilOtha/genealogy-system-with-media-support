...
class GenealogyTest {
    ...
    void addMediaFile() {
        ...
        // Valid fileLocation
        FileIdentifier fileIdentifier = genealogy.addMediaFile("D:/media/toronto.png");
        ...
        Assertions.assertThrows(IllegalArgumentException.class,()->{
            genealogy.addMediaFile("D:/media/toronto.png");
        });
    }
    ...
    void recordMediaAttributes() {
        ...
        FileIdentifier fileIdentifier2 = genealogy.findMediaFile("D:/media/toronto.png");
        ...
        // adding valid map
        Map<String,String> attributes3 = new HashMap<>();
        attributes3.put("date", "2019-04");
        attributes3.put("location", "Toronto Airport");
        attributes3.put("city","Toronto");
        assertTrue(genealogy.recordMediaAttributes(fileIdentifier2,attributes3));

        // re-assigning same attributes except with one value changed
        attributes3.put("date","2021-07");
        assertTrue(genealogy.recordMediaAttributes(fileIdentifier2,attributes3));
    }
